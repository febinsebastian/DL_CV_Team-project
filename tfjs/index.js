...
const MOBILENET_MODEL_PATH = isDev ? 'http://localhost:1234/emotion_detection/model.json' : './emotion_detection/model.json';
const DETECTION_MODEL_PATH = isDev ? 'http://localhost:1234/face_detection': './face_detection';
